...
def ensure_markers(content: str) -> str:
    ...
    if MEM_START in content and PUB_START in content and DISS_START in content and CUSTOM_START in content:
        return content

    # Add custom markers if missing (for existing files that don't have them yet)
    if MEM_START in content and CUSTOM_START not in content:
...
<!-- Auto-generated sections below -->
<!-- They are generated from data/members.yml, data/dois.yml and data/dissertations.yml. -->
