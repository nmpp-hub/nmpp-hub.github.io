...
- Together with the group of [Structure-Preserving Finite Element Methods](https://www.ipp.mpg.de/4105128/gspm), new discretizations for linear and nonlinear MHD that preserve structures such as divergence-free magnetic fields are investigated.
- Together with the group of [Kinetic and gyrokinetic models](https://www.ipp.mpg.de/4104717/kgkm), we study stability properties of structure-preserving discretizations of fluid-type models in the framework of finite element exterior calculus (FEEC).
