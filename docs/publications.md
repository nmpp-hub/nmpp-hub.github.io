...
Search and filter NMPP division publications.

<input id="pub-search" type="search" placeholder="Search by title, author, year, journal, or keyword..." aria-label="Search publications" />
